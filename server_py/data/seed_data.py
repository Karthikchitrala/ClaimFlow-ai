# server_py/data/seed_data.py
"""
High-fidelity realistic seed data for ClaimFlow AI Python Backend.
Includes messy receipts, duplicate submissions, and limit thresholds.
"""
...
INITIAL_CLAIMS = [
    ...
    # 3. Priya Sharma: Monitor stand & mechanical keyboard (Approved, awaiting payout) - pushed Priya to 95.2% limit!
    {
        "id": "CLM-2026-0820",
        "userId": "usr_priya_sharma",
        "userName": "Priya Sharma",
    ...
    # 4. Rajesh Kumar: Original Swiggy Team Lunch receipt (Paid)
    {
    ...
    # 7. Vikram Malhotra: Hotel stay in Mumbai (Approved, awaiting payout)
    {
